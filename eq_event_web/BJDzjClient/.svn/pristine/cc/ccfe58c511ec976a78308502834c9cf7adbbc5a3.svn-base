...
var  page = {
    ...
    "pagelistcount":10,//每一页显示的内容条数
      "init":function(listCount,currentPage,options){
	    ...
	    page.initPage(listCount,currentPage,options);
  },
  /**
     * 初始化数据处理
     ...
     */
  "initPage":function(listCount,currentPage,op){
        ...
        page.setPageListCount(listCount,currentPage,op);
   },
    /**
     * 初始化分页界面
     * @param listCount 列表总量
     ...
     */
    "setPageListCount":function(listCount,currentPage,os){
        listCount = parseInt(listCount);
        currentPage = parseInt(currentPage);
        page.initWithUl(listCount,currentPage);
        page.initPageEvent(listCount);
        page.viewPage(currentPage,listCount,page.pagelistcount,page.data,os)
//      fun(currentPage);
    },
    //页面显示功能
     "viewPage":function (currentPage,listCount,pagelistcount,data,options){
    ...
    "initPageEvent":function(listCount){
        $("#"+page.pageId +">li[class='pageItem']").on("click",function(){
        	searchShockP($(this).attr("page-data"));
